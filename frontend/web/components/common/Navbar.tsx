                ...
                <div className="flex justify-between items-center h-16">
                    <div className="flex items-center space-x-8">
                        ...
                        <div className="hidden md:flex items-center space-x-6">
                            <Link href="/write" className="text-slate-600 hover:text-indigo-600 font-medium transition-colors">
                                {t('write')}
                            </Link>
                            <Link href="/review" className="text-slate-600 hover:text-indigo-600 font-medium transition-colors">
                                {t('review')}
                            </Link>
                            <Link href="/statistics" className="text-slate-600 hover:text-indigo-600 font-medium transition-colors">
                                {t('statistics')}
                            </Link>
                        </div>
                    </div>

...
export const calculateScore = (features: Features, errors: GrammarError[], totalTokens: number): ScoreResult => {
    // 1. Vocab Score (0-1)
    ...
    if (finalScore >= 0.80) cefrLevel = 'C2';
    else if (finalScore >= 0.65) cefrLevel = 'C1';
    else if (finalScore >= 0.50) cefrLevel = 'B2';
    else if (finalScore >= 0.35) cefrLevel = 'B1';
    else if (finalScore >= 0.20) cefrLevel = 'A2';
    else cefrLevel = 'A1';
